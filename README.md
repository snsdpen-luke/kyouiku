...
| **進路設計工房** | 「こんな暮らし」を選んで必要な手取りを逆算し、ハローワークの求人票（高卒）を欄ごとにタップして読み方を学ぶ | 進路学習（高2） |
...
| `regression-shinro.js` | 進路設計工房のリグレッション（jsdom・102項目） |
...
node regression-shinro.js 進路設計工房.html       # 102項目すべて合格すればOK
```
...
画面右上の版表示（`版 2026-09-18b`）も更新すること。
